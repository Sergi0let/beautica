...
export const CustomCursor = () => {
  ...
  return (
    <div
      className={`pointer-events-none fixed left-0 top-0 z-50 hidden size-[var(--64-120)] flex-col items-center justify-center rounded-full bg-accent text-sm transition-opacity duration-300 md:flex ${
