  ...
  return (
    <div className="wrap-primary min-h-screen">
      <div className="flex-center">
        <h1 className="title-hero" data-fade aria-label="Тонке підкреслення Вашої природної краси"></h1>
      </div>
      <div className="grid-rows-[auto, 1fr] mb-[var(--64-92)] grid grid-cols-2 gap-2 lg:grid-cols-3 lg:grid-rows-1 lg:gap-4">
        ...
        <div className="flex-center-col col-start-1 -col-end-1 row-start-1 mx-auto mb-8 w-[var(--240-395)] lg:col-span-1 lg:row-auto">
          <p data-fade data-delay-two className="mb-[var(--16-32)] text-center text-txt-hero text-secondary-100">
